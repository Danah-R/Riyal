      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            ...upcomingRenewals.map((r) => Padding(
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: const AppIcon(assetPath: 'assets/icons/app_logo.svg', size: 26),
        ),
        Container(
          width: 44,
          height: 44,
      ...
      child: Column(
        ...
        children: [
          const Text(
            ...
            style: TextStyle(color: AppColors.textSecondary, fontSize: 14, height: 1.3),
          ),
