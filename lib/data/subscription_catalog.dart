...
const List<CatalogApp> subscriptionCatalog = [
  ...
  CatalogApp(
    'Spotify',
    'lib/assets/logos/Spotify_App_Logo.svg.webp',
    _entertainment,
  ),
  CatalogApp(
    'Apple Music',
    'lib/assets/logos/Apple_Music_icon.svg.webp',
    _entertainment,
  ),
  CatalogApp(
    'Apple TV+',
    'lib/assets/logos/apple-tv-logo-png_seeklogo-314167.png',
    _entertainment,
  ),
  CatalogApp(
    'Amazon Prime Video',
  ...
  CatalogApp(
    'SoundCloud',
    'lib/assets/logos/soundcloud-logo_578229-231.png',
    _entertainment,
  ),
  ...
  CatalogApp(
    'OSN+',
    'lib/assets/logos/osn-logo-png_seeklogo-629451.png',
    _entertainment,
  ),
  CatalogApp(
    'StarzPlay',
    'lib/assets/logos/20241007-starzplay-logo.webp',
    _entertainment,
  ),
  CatalogApp('Thmanya', 'lib/assets/logos/thamanya.jpg', _entertainment),
  CatalogApp(
    'noon',
    'lib/assets/logos/noon-com-logo-png_seeklogo-467329.png',
    _shoppingDelivery,
  ),
  ...
  CatalogApp(
    'PlayStation Plus',
    'lib/assets/logos/playstation-plus-logo-png_seeklogo-411713.png',
    _entertainment,
  ),
  CatalogApp(
    'Nintendo Switch Online',
    'lib/assets/logos/nintendo.png',
    _entertainment,
  ),
  ...
  CatalogApp(
    'Midjourney',
    'lib/assets/logos/midjourney-logo-png_seeklogo-501203.png',
    _ai,
  ),
  ...
  CatalogApp(
    'GitHub',
    'lib/assets/logos/github_logo_icon_229278.webp',
    _productivity,
  ),
  ...
  CatalogApp(
    'Notability',
    'lib/assets/logos/Notability_Icon_Vectorized.svg.webp',
    _education,
  ),
  ...
  CatalogApp(
    'Slack',
    'lib/assets/logos/Slack_icon_2019.svg.webp',
    _productivity,
  ),
  CatalogApp(
    'Zoom',
  ...
  CatalogApp(
    'Google Workspace',
    'lib/assets/logos/google workspace.jpeg',
    _productivity,
  ),
  CatalogApp(
    'Microsoft 365',
    'lib/assets/logos/microsoft365.png',
    _productivity,
  ),
  CatalogApp(
    'Adobe Creative Cloud',
    'lib/assets/logos/Adobe_Creative_Cloud_rainbow_icon.svg',
    _productivity,
  ),
  CatalogApp(
    'Adobe Acrobat',
    'lib/assets/logos/Adobe_Acrobat_DC_logo_2020.svg.webp',
    _productivity,
  ),
  CatalogApp(
    'Grammarly',
    'lib/assets/logos/grammarly-icon.webp',
    _productivity,
  ),
  ...
  CatalogApp(
    'HungerStation',
    'lib/assets/logos/hungerstation.png',
    _shoppingDelivery,
  ),
